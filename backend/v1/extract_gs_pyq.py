...
# Paths are relative to the hermes_v2/ directory
BASE_DIR = Path(__file__).parent.parent  # hermes_v2/
PREVIOUS_YEAR_DIR = BASE_DIR / "previous_year_questions"

prelims_pdf_path = str(PREVIOUS_YEAR_DIR / "Previous-Papers-Prelims-GS-Topicwise-English-1.pdf")
mains_pdf_path = str(PREVIOUS_YEAR_DIR / "MAINS-PAPER-GS-YEAR-WISE_2013-2025.pdf")
output_dir = str(Path(__file__).parent)  # hermes_v2/dataset/
