"""
UPSC Final Test — Clean Output to Single File
═══════════════════════════════════════════════════════════════
Shows actual answer content, not just metadata.
All results saved to ONE file: results_final.jsonl
"""
...
# ═══════════════════════════════════════════════════════════════
# 10 UPSC QUESTIONS — 10 DIFFERENT DOMAINS
# ═══════════════════════════════════════════════════════════════
...
async def run_test():
    ...
    output_file = output_dir / "results_final.jsonl"
    # Clear file at start
    ...
    for i, item in enumerate(QUESTIONS):
        ...
        # Append to single file immediately
